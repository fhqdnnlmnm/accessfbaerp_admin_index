...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'add_customer',title: '添加客户',name: 'add_customer',component:()=> import('@/views/customer/addCustomer.vue')}
    ]
};
...
export const appRouter = [
    ...
    // 货运方案
    {
        ...
        component: Main,
        children: [
            { path: 'originport', title: '起运港', name: 'origin_port', component: () => import('@/views/solution/origin_port.vue') },
            { path: 'destport', title: '目的港', name: 'dest_port', component: () => import('@/views/solution/dest_port.vue') }
        ]
    }
];
